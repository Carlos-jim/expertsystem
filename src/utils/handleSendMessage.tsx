...
export const handleSendMessage = (
  ...
  // Condición para omitir la pregunta 1 si se responde "Sí" a la pregunta 0
  if (currentQuestionIndex === 0 && respuestaNumerica === 1) {
  ...
  if (currentQuestionIndex === 13 && respuestaNumerica === 1) {
    ...
    setCurrentQuestionIndex((prevIndex) => prevIndex + 3); // Saltar las preguntas 15 y 16
    return;
  }
